...
-- Records of acceso
-- ----------------------------
INSERT INTO `acceso` VALUES (1, 'bodegalucero@gmail.com', '$2y$10$tdrpW.jUUaVnsEcRDkkoXOlUBlTdMKBZluAA5frChR1/lxglvdmyC', 'bda99a06eec67cd009c11bba0abcb566b6af33f8b3735f585ba9883dfe970ec1273edc7325', 1);
...
INSERT INTO `acceso` VALUES (22, 'luisalcantara@yopmail.com', '$2y$10$tdrpW.jUUaVnsEcRDkkoXOlUBlTdMKBZluAA5frChR1/lxglvdmyC', '', 1);
...
INSERT INTO `productos` VALUES (46, 1, 4, 'Café Instantáneo Nescafé Tradición Frasco 170g', '', 8.00, 0.00, 11.50, 15.00, 0.00, '1684295057_Mesa-de-trabajo-21-3.jpg', 1);
...
INSERT INTO `productos` VALUES (57, 1, 9, 'Colgate Luminus White 150ml', '', 6.00, 10.00, 6.20, 6.70, 0.00, '1684726298_Colgate Luminus White.jpg', 1);
...
-- Records of ventas
-- ----------------------------
INSERT INTO `ventas` VALUES (23, 6, 'AV. Los libertadores 14 - Carabayllo', '987845123', 'DELIVERY', 'EFECTIVO', 'CLIENTE', 24.00, 4.32, 10.00, 34.00, 1, '2022-06-02 11:13:14');
...
INSERT INTO `ventas` VALUES (25, 1, 'Av. los jasmines 351 - Comas', '984545451', 'DELIVERY', 'CARD', 'CLIENTE', 29.50, 5.31, 10.00, 39.50, 1, '2022-06-14 19:06:25');
...
INSERT INTO `ventas` VALUES (28, 1, 'Av. los jasmines 351 - Comas', '984545451', 'DELIVERY', 'CARD', 'CLIENTE', 4.50, 0.81, 10.00, 14.50, 1, '2023-05-14 19:17:29');
...
INSERT INTO `ventas` VALUES (31, 1, 'Av. los jasmines 351 - Comas', '984545451', 'DELIVERY', 'CARD', 'CLIENTE', 4.50, 0.81, 10.00, 14.50, 1, '2023-04-14 19:21:50');
INSERT INTO `ventas` VALUES (32, 1, 'Av. los jasmines 351 - Comas', '984545451', 'DELIVERY', 'CARD', 'CLIENTE', 4.50, 0.81, 10.00, 14.50, 1, '2022-06-14 19:25:34');
...
INSERT INTO `ventas` VALUES (46, 1, 'Av. los jasmines 351 - Comas', '984545451', 'DELIVERY', 'CARD', 'CLIENTE', 21.70, 3.91, 10.00, 31.70, 1, '2023-06-16 23:59:28');
...
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_spanish_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `ventas_detalle` VALUES (78, 46, 46, 15.00, 1, 15.00, 1);
INSERT INTO `ventas_detalle` VALUES (79, 46, 57, 6.70, 1, 6.70, 1);
...
-- ----------------------------
-- Procedure structure for SP_DASHBOARD_PRODUCTOS_VENDIDOS
-- ----------------------------
DROP PROCEDURE IF EXISTS `SP_DASHBOARD_PRODUCTOS_VENDIDOS`;
delimiter ;;
CREATE PROCEDURE `SP_DASHBOARD_PRODUCTOS_VENDIDOS`(IN _fechaInicio DATE, IN _fechaFin DATE, IN _idBodega INT)
BEGIN
	SELECT
	p.nombre,
...
-------------------------------------
--AGREGAR BASE DE DATOS YSABEL--
------------------------------------



CREATE DATABASE  IF NOT EXISTS `melamiservice` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `melamiservice`;
...
CREATE TABLE `acceso` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `pedido` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pedido` VALUES (1,'Bryan','San Pedro','Lima','666 666 666','bryanvirgo9@gmail.com','2024-06-06'),(24,'aaaa','ssss','ssss','9999999999','sssss','2023-06-14');
...
-- Dump completed on 2024-06-09 17:37:50


-------------------------------------
--AGREGAR BASE DE DATOS BRYANL--
------------------------------------
...
BEGIN
	INSERT INTO categorias(nombre, marca, precio, stock) VALUES(_nombre, _marca, _precio, _stock);
END
;;
delimiter ;
