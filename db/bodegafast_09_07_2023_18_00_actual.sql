...
-- ----------------------------
-- Procedure structure for SP_DASHBOARD_PRODUCTOS_VENDIDOS_CATEGORIA
-- ----------------------------
DROP PROCEDURE IF EXISTS `SP_DASHBOARD_PRODUCTOS_VENDIDOS_CATEGORIA`;
delimiter ;;
CREATE PROCEDURE `SP_DASHBOARD_PRODUCTOS_VENDIDOS_CATEGORIA`(IN _fechaInicio DATE, 
IN _fechaFin DATE, 
IN _idBodega INT)
BEGIN
	SELECT
...
-- ----------------------------
-- Procedure structure for SP_DASHBOARD_PRODUCTOS_VENDIDOS_YEAR
-- ----------------------------
DROP PROCEDURE IF EXISTS `SP_DASHBOARD_PRODUCTOS_VENDIDOS_YEAR`;
delimiter ;;
CREATE PROCEDURE `SP_DASHBOARD_PRODUCTOS_VENDIDOS_YEAR`(IN _fechaInicio DATE, 
IN _fechaFin DATE, 
IN _idBodega INT)
BEGIN
...
-- ----------------------------
-- Procedure structure for SP_DASHBOARD_RANKIN_BODEGAS
-- ----------------------------
DROP PROCEDURE IF EXISTS `SP_DASHBOARD_RANKIN_BODEGAS`;
delimiter ;;
CREATE PROCEDURE `SP_DASHBOARD_RANKIN_BODEGAS`(IN _fechaInicio DATE, 
IN _fechaFin DATE)
BEGIN
	SELECT
